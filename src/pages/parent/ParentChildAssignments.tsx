...
export default function ParentChildAssignments() {
  ...
  useEffect(() => {
    if (!profile) return;
    // The backend filters assignments by current student or linked student for parents automatically
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Child's Assignments" description="Track and view upcoming assignments for your child." />
      ...
      {loading ? (
        ...
        <EmptyState 
            ...
            description="Your child has no pending assignments at the moment." 
        />
      ) : (
